...
public class GL {
	...
	public static void init() {
		...
		versionMajor = glGetInteger(GL30.GL_MAJOR_VERSION);
		versionMinor = glGetInteger(GL30.GL_MINOR_VERSION);
		version = versionMajor * 10 + versionMinor;
		maxTextureUnitsAmount = glGetInteger(GL20.GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS);
