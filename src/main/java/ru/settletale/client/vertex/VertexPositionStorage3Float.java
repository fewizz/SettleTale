...
public class VertexPositionStorage3Float implements IVertexPositionStorage {
	ByteBuffer pb;
	ByteBuffer ib;
	
	public VertexPositionStorage3Float() {
	...
	@Override
	public void position(double x, double y, double z, int id) {
		...
		pb.putFloat(id + Float.BYTES * 0, (float) x);
		pb.putFloat(id + Float.BYTES * 1, (float) y);
		pb.putFloat(id + Float.BYTES * 2, (float) z);
